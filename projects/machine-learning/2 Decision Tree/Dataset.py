...
class Dataset(object):
    ...
    def load_iris(self):
        with open("data/iris.names.txt") as f:
            self.DESCR = f.readlines()

        raw_data = np.genfromtxt("data/iris.data.txt", dtype=str, delimiter=',')
    ...
    def load_lenses(self):
        with open("data/lenses.names.txt") as f:
            self.DESCR = f.readlines()

        raw_data = np.genfromtxt("data/lenses.data.txt", dtype=str)[:, 1:]
    ...
    def load_voting(self):
        ...
        with open("data/house-votes-84.names.txt") as f:
            self.DESCR = f.readlines()

        raw_data = np.genfromtxt("data/house-votes-84.data.txt", dtype=str, delimiter=',')
    ...
    def load_chess(self):
        ...
        with open("data/krkopt.info.txt") as f:
            self.DESCR = f.readlines()

        raw_data = np.genfromtxt("data/krkopt.data.txt", dtype=str, delimiter=',')
